...
(function (factory, window) {
	...
	TIMAAT.EmailAddressType = class EmailAddressType {
		constructor(model) {
			...
			this.listView.find('.timaat-user-log').on('inserted.bs.popover', function () {
				if (emailAddressType.model.lastEditedAt == null) {
					$('.timaat-user-log-details').html(
						'<b><i class="fas fa-plus-square"></i> Erstellt von <span class="timaat-user-id" data-userid="'+emailAddressType.model.createdByUserAccount.id+'">[ID '+emailAddressType.model.createdByUserAccount.id+']</span></b><br>\
					...
					$('.timaat-user-log-details').html(
							'<b><i class="fas fa-plus-square"></i> Erstellt von <span class="timaat-user-id" data-userid="'+emailAddressType.model.createdByUserAccount.id+'">[ID '+emailAddressType.model.createdByUserAccount.id+']</span></b><br>\
							'+TIMAAT.Util.formatDate(emailAddressType.model.createdAt)+'<br>\
							<b><i class="fas fa-edit"></i> Bearbeitet von <span class="timaat-user-id" data-userid="'+emailAddressType.model.lastEditedByUserAccount.id+'">[ID '+emailAddressType.model.lastEditedByUserAccount.id+']</span></b><br>\
			...
			// remove handler
			this.listView.find('.timaat-emailaddresstype-remove').click(this, function(ev) {
				ev.stopPropagation();
				TIMAAT.UI.hidePopups();				
