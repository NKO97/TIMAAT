			...
			this.listView.find('.timaat-user-log').on('inserted.bs.popover', function () {
				if (phoneNumberType.model.lastEditedAt == null) {
					$('.timaat-user-log-details').html(
						'<b><i class="fas fa-plus-square"></i> Erstellt von <span class="timaat-user-id" data-userid="'+phoneNumberType.model.createdByUserAccount.id+'">[ID '+phoneNumberType.model.createdByUserAccount.id+']</span></b><br>\
					...
					$('.timaat-user-log-details').html(
							'<b><i class="fas fa-plus-square"></i> Erstellt von <span class="timaat-user-id" data-userid="'+phoneNumberType.model.createdByUserAccount.id+'">[ID '+phoneNumberType.model.createdByUserAccount.id+']</span></b><br>\
							'+TIMAAT.Util.formatDate(phoneNumberType.model.createdAt)+'<br>\
							<b><i class="fas fa-edit"></i> Bearbeitet von <span class="timaat-user-id" data-userid="'+phoneNumberType.model.lastEditedByUserAccount.id+'">[ID '+phoneNumberType.model.lastEditedByUserAccount.id+']</span></b><br>\
