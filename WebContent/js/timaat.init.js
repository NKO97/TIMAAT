requirejs.config({
	...
	paths: {
		...
		"TIMAAT-mediaCollectionDatasets": 'datasets/timaat.datasets.mediacollection',
		...
		"TIMAAT-mediaCollectionService" : 'service/timaat.service.mediacollection',
...
//	'leaflet-pathtransform',
	...
	'leaflet-sidebar',
	  ...
	  console.log("TIMAAT::Init");
		requirejs(['moment', 'datatables', 'sbadmin2',
			'TIMAAT', 'TIMAAT-html', 'TIMAAT-ui', 'TIMAAT-ui-inspector', 'TIMAAT-uploadManager', 'TIMAAT-videoChooser', 'TIMAAT-videoPlayer', 
			'TIMAAT-settings', 'TIMAAT-util', 'TIMAAT-datasets', 'TIMAAT-service',
			'TIMAAT-marker', 'TIMAAT-keyframe', 'TIMAAT-annotation', 'TIMAAT-analysisSegment',
			'TIMAAT-category', 'TIMAAT-categorySet', 'TIMAAT-categoryLists', 'TIMAAT-categoryService',
			'TIMAAT-role', 'TIMAAT-roleGroup', 'TIMAAT-roleLists', 'TIMAAT-roleService',
			'TIMAAT-language', 'TIMAAT-languageLists', 'TIMAAT-languageService',
			'TIMAAT-medium', 'TIMAAT-mediaDatasets', 'TIMAAT-mediaService', 'TIMAAT-mediaType', 
			'TIMAAT-mediumCollection', "TIMAAT-mediaCollectionDatasets", 'TIMAAT-mediaCollectionService',
			'TIMAAT-actor','TIMAAT-actorDatasets', 'TIMAAT-actorService', 'TIMAAT-actorType', 'TIMAAT-addressType', 'TIMAAT-emailAddressType', 
			'TIMAAT-location', 'TIMAAT-locationDatasets', 'TIMAAT-locationService', 'TIMAAT-locationType', 'TIMAAT-country', 'TIMAAT-province', 'TIMAAT-county', 'TIMAAT-city', 'TIMAAT-street',
			'TIMAAT-event', 'TIMAAT-eventDatasets', 'TIMAAT-eventService',
