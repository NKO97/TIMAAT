requirejs.config({
	...
	paths: {
		...
		"TIMAAT-settings":			'timaat.settings',
		...
		"TIMAAT-marker":			'timaat.marker',
		"TIMAAT-annotation":		'timaat.annotation', 
		"TIMAAT-categoryset":		'timaat.categoryset', 
		"TIMAAT-analysissegment":	'timaat.analysissegment', 
		"TIMAAT-medium":			'timaat.medium', 
