...
public class CountryEndpoint {
  ...
  //   @Consumes(MediaType.APPLICATION_JSON)
	...
	// 	System.out.println("CountryEndpoint: updateCountry - jsonData" + jsonData);
	// 	ObjectMapper mapper = new ObjectMapper();
	...
	// 	} catch (IOException e) {
	// 		System.out.println("CountryEndpoint: IOException" + e);
	// 		e.printStackTrace();
	// 		return Response.status(Status.BAD_REQUEST).build();
	// 	}
	...
	// 	System.out.println("CountryEndpoint: updateCountry - updated");
	// 	return Response.ok().entity(country).build();
	// }
