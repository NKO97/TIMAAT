...
public class EndpointMusic {
    ...
    public Response getMediumByMusicId(@PathParam("id") int id) {
        ...
        if (music == null) return Response.status(Status.NOT_FOUND).build();
        Medium medium = null;
        Query countQuery = entityManager.createQuery("SELECT COUNT(m) FROM Medium m WHERE m.music.id = :musicId").setParameter("musicId", id);
        long resultsTotal = (long) countQuery.getSingleResult();
        if (resultsTotal == 0) return Response.ok().entity(0).build();
        try {
            medium = entityManager.createQuery("SELECT m FROM Medium m WHERE m.music.id = :musicId", Medium.class).setParameter("musicId", id).getSingleResult();
    ...
    public Response getMusicList(@QueryParam("draw") Integer draw, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("orderby") String orderby, @QueryParam("dir") String direction, @QueryParam("exclude_annotation") Integer excludedAnnotationId, @QueryParam("search") String search, @QueryParam("musicTypeId") Integer musicTypeId, @Context HttpHeaders httpHeaders) {
      ...
      if (draw == null) draw = 0;
        ...
        if ((search != null && !search.isEmpty()) || excludedAnnotationId != null || musicTypeId != null) {
            ...
            query = entityManager.createQuery(sql).setParameter("search", search).setParameter("excludedAnnotationId", excludedAnnotationId).setParameter("musicTypeId", musicTypeId);
    ...
    public Response getMusicFormElementTypeSelectList(@QueryParam("language") String languageCode) {
        ...
        for (MusicFormElementTypeTranslation musicFormElementTypeTranslation : musicFormElementTypeTranslationList) {
            musicFormElementTypeSelectList.add(new SelectElement<Integer>(musicFormElementTypeTranslation.getMusicFormElementType().getId(), musicFormElementTypeTranslation.getType()));
        }
    ...
    public Response getMusicChangeInTempoElementSelectList(@QueryParam("language") String languageCode) {
        ...
        for (ChangeInTempoTranslation changeInTempoTranslation : changeInTempoTranslationList) {
            selectList.add(new SelectElement<Integer>(changeInTempoTranslation.getChangeInTempo().getId(), changeInTempoTranslation.getType()));
        }
    ...
    public Response getMusicArticulationElementSelectList(@QueryParam("language") String languageCode) {
        ...
        for (ArticulationTranslation articulationTranslation : articulationTranslationList) {
            selectList.add(new SelectElement<Integer>(articulationTranslation.getArticulation().getId(), articulationTranslation.getType()));
        }
        return Response.ok().entity(selectList).build();
    }
    ...
    public Response getMusicTextSettingElementTypeSelectList(@PathParam("id") Integer id, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("language") String languageCode) {
        ...
        Query query;
        query = TIMAATApp.emf.createEntityManager().createQuery("SELECT mtstt FROM MusicTextSettingElementTypeTranslation mtstt WHERE mtstt.language.id = (SELECT l.id FROM Language l WHERE l.code = '" + languageCode + "') ORDER BY mtstt.type ASC");
        ...
        for (MusicTextSettingElementTypeTranslation musicTextSettingElementTypeTranslation : musicTextSettingElementTypeTranslationList) {
            musicTextSettingElementTypeSelectList.add(new SelectElement<Integer>(musicTextSettingElementTypeTranslation.getMusicTextSettingElementType().getId(), musicTextSettingElementTypeTranslation.getType()));
        }
        selectElementList = musicTextSettingElementTypeSelectList;

        if (selectElementList.size() > 0) return Response.ok().entity(selectElementList).build();
        else return Response.ok().entity(selectElementWithChildrenList).build();
    }
    ...
    public Response getMusicDynamicsElementTypeSelectList(@PathParam("id") Integer id, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("language") String languageCode) {
        ...
        List<SelectElementWithChildren> selectElementWithChildrenList = new ArrayList<>();
        Query query;
        query = TIMAATApp.emf.createEntityManager().createQuery("SELECT mdett FROM MusicDynamicsElementTypeTranslation mdett WHERE mdett.language.id = (SELECT l.id FROM Language l WHERE l.code = '" + languageCode + "') ORDER BY mdett.type ASC");
        ...
        for (MusicDynamicsElementTypeTranslation musicDynamicsElementTypeTranslation : musicDynamicsElementTypeTranslationList) {
            musicDynamicsElementTypeSelectList.add(new SelectElement<Integer>(musicDynamicsElementTypeTranslation.getMusicDynamicsElementType().getId(), musicDynamicsElementTypeTranslation.getType()));
        }
    ...
    public Response getVoiceLeadingPatternSelectList(@QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("orderby") String orderby, @QueryParam("dir") String direction, @QueryParam("search") String search, @QueryParam("language") String languageCode) {
        ...
        List<SelectElementWithChildren> selectElementWithChildrenList = new ArrayList<>();
        Query countQuery;
        countQuery = TIMAATApp.emf.createEntityManager().createQuery("SELECT COUNT (vlpt.id) FROM VoiceLeadingPatternTranslation vlpt WHERE vlpt.language.id = (SELECT l.id FROM Language l WHERE l.code = '" + languageCode + "')"); // TODO Fallback?
        long count = (long) countQuery.getSingleResult();
        if (count == 0) return Response.ok().entity(selectElementList).build();
        Query query;
        query = TIMAATApp.emf.createEntityManager().createQuery("SELECT vlpt FROM VoiceLeadingPatternTranslation vlpt WHERE vlpt.language.id = (SELECT l.id FROM Language l WHERE l.code = '" + languageCode + "') ORDER BY vlpt.type ASC");
        ...
        for (VoiceLeadingPatternTranslation voiceLeadingPatternTranslation : voiceLeadingPatternTranslationList) {
            voiceLeadingPatternSelectList.add(new SelectElement<Integer>(voiceLeadingPatternTranslation.getVoiceLeadingPattern().getId(), voiceLeadingPatternTranslation.getType()));
        }
    ...
    public Response getMediumSelectList(@QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("search") String search, @QueryParam("language") String languageCode) {
        ...
        Query query;
        if (search != null && search.length() > 0) {
            query = TIMAATApp.emf.createEntityManager().createQuery("SELECT m FROM Medium m WHERE m.music IS NULL AND lower (m.displayTitle.name) LIKE lower(concat('%', :name, '%')) ORDER BY m.displayTitle.name ASC");
            query.setParameter("name", search);
        } else {
            query = TIMAATApp.emf.createEntityManager().createQuery("SELECT m FROM Medium m WHERE m.music IS NULL ORDER BY m.displayTitle.name ASC");
        }
    ...
    public Response getArticulationSelectList(@PathParam("id") Integer id, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("language") String languageCode) {
        ...
        List<SelectElementWithChildren> selectElementWithChildrenList = new ArrayList<>();
        Query query;
        query = TIMAATApp.emf.createEntityManager().createQuery("SELECT at FROM ArticulationTranslation at WHERE at.language.id = (SELECT l.id FROM Language l WHERE l.code = '" + languageCode + "') ORDER BY at.type ASC");
        List<ArticulationTranslation> articulationTranslationList = castList(ArticulationTranslation.class, query.getResultList());
    ...
    public Response getDynamicMarkingSelectList(@PathParam("id") Integer id, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("language") String languageCode) {
        ...
        List<SelectElementWithChildren> selectElementWithChildrenList = new ArrayList<>();
        Query query;
        query = TIMAATApp.emf.createEntityManager().createQuery("SELECT dmt FROM DynamicMarkingTranslation dmt WHERE dmt.language.id = (SELECT l.id FROM Language l WHERE l.code = '" + languageCode + "') ORDER BY dmt.type ASC");
    ...
    public Response getMusicalKeySelectList(@PathParam("id") Integer id, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("language") String languageCode) {
        ...
        List<SelectElementWithChildren> selectElementWithChildrenList = new ArrayList<>();
        Query query;
        query = TIMAATApp.emf.createEntityManager().createQuery("SELECT mkt FROM MusicalKeyTranslation mkt WHERE mkt.language.id = (SELECT l.id FROM Language l WHERE l.code = '" + languageCode + "') ORDER BY mkt.type ASC");
    ...
    public Response getTempoMarkingSelectList(@PathParam("id") Integer id, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("language") String languageCode) {
        ...
        List<SelectElementWithChildren> selectElementWithChildrenList = new ArrayList<>();
        Query query;
        query = TIMAATApp.emf.createEntityManager().createQuery("SELECT tmt FROM TempoMarkingTranslation tmt WHERE tmt.language.id = (SELECT l.id FROM Language l WHERE l.code = '" + languageCode + "') ORDER BY tmt.type ASC");
    ...
    public Music createMusic(@Valid CreateUpdateMusicPayload createUpdateMusicPayload) throws DbTransactionExecutionException {
        ...
        MusicStorage.CreateMusic createMusic = new MusicStorage.CreateMusic(createUpdateMusicPayload.getTitle().getLanguageId(),
                createUpdateMusicPayload.getTitle().getName(), createUpdateMusicPayload.getTempo(),
                createUpdateMusicPayload.getTempoMarkingId(), createUpdateMusicPayload.getBeat(),
                createUpdateMusicPayload.getMusicalKeyId(), createUpdateMusicPayload.getDynamicMarkingId(),
                createUpdateMusicPayload.getMusicTextSettingElementTypeId(), createUpdateMusicPayload.getVoiceLeadingPatternIds(),
                createUpdateMusicPayload.getInstrumentation(), createUpdateMusicPayload.getRemark(), createUpdateMusicPayload.getMediumId(),
    ...
    public Music updateMusic(@PathParam("id") int id, @Valid CreateUpdateMusicPayload createUpdateMusicPayload) throws DbTransactionExecutionException {
        int userId = (int) containerRequestContext.getProperty("TIMAAT.userID");
        MusicStorage.UpdateMusic updateMusic = new MusicStorage.UpdateMusic(id, createUpdateMusicPayload.getTitle().getLanguageId(),
                createUpdateMusicPayload.getTitle().getName(), createUpdateMusicPayload.getTempo(),
                createUpdateMusicPayload.getTempoMarkingId(), createUpdateMusicPayload.getBeat(),
                createUpdateMusicPayload.getMusicalKeyId(), createUpdateMusicPayload.getDynamicMarkingId(),
                createUpdateMusicPayload.getMusicTextSettingElementTypeId(), createUpdateMusicPayload.getVoiceLeadingPatternIds(),
    ...
    public Response deleteMusic(@PathParam("id") int id) {
        ...
        // add log entry
        UserLogManager.getLogger().addLogEntry((int) containerRequestContext.getProperty("TIMAAT.userID"), UserLogManager.LogEvents.MUSICDELETED);
    ...
    public Response createTitle(@PathParam("id") int id, String jsonData) {
        ...
        // add log entry
        UserLogManager.getLogger().addLogEntry((int) containerRequestContext.getProperty("TIMAAT.userID"), UserLogManager.LogEvents.TITLECREATED);
    ...
    public Response updateTitle(@PathParam("id") int id, String jsonData) {
        ...
        // add log entry
        UserLogManager.getLogger().addLogEntry((int) containerRequestContext.getProperty("TIMAAT.userID"), UserLogManager.LogEvents.TITLEEDITED);
    ...
    public Response deleteTitle(@PathParam("id") int id) {
        ...
        entityTransaction.commit();
        // add log entry
        UserLogManager.getLogger().addLogEntry((int) containerRequestContext.getProperty("TIMAAT.userID"), UserLogManager.LogEvents.TITLEDELETED);
        return Response.ok().build();
    }
    ...
    public Response addMusicHasActorWithRoles(@PathParam("musicId") int musicId, @PathParam("actorId") int actorId, @PathParam("roleId") int roleId) {
        ...
        try {
            Query countQuery = entityManager.createQuery("SELECT COUNT(mhawr) FROM MusicHasActorWithRole mhawr WHERE mhawr.music=:music AND mhawr.actor=:actor AND mhawr.role=:role").setParameter("music", music).setParameter("actor", actor).setParameter("role", role);
            long recordsTotal = (long) countQuery.getSingleResult();
            if (recordsTotal == 1) {
                mhawr = (MusicHasActorWithRole) entityManager.createQuery("SELECT mhawr FROM MusicHasActorWithRole mhawr WHERE mhawr.music=:music AND mhawr.actor=:actor AND mhawr.role=:role").setParameter("music", music).setParameter("actor", actor).setParameter("role", role).getSingleResult();
            }
        } catch (Exception e) {
            e.printStackTrace();
            // doesn't matter
    ...
    public Response deleteActorFromMusicHasActorWithRoles(@PathParam("musicId") int musicId, @PathParam("actorId") int actorId) {
        ...
        try {
            EntityTransaction entityTransaction = entityManager.getTransaction();
            entityTransaction.begin();
            entityManager.createQuery("DELETE FROM MusicHasActorWithRole mhawr WHERE mhawr.music=:music AND mhawr.actor=:actor").setParameter("music", music).setParameter("actor", actor).executeUpdate();
            entityTransaction.commit();
            entityManager.refresh(music);
            // entityManager.refresh(actor);
        } catch (Exception e) {
    ...
    public Response deleteRoleFromMusicHasActorWithRoles(@PathParam("musicId") int musicId, @PathParam("actorId") int actorId, @PathParam("roleId") int roleId) {
        ...
        try {
            EntityTransaction entityTransaction = entityManager.getTransaction();
            entityTransaction.begin();
            entityManager.createQuery("DELETE FROM MusicHasActorWithRole mhawr WHERE mhawr.music=:music AND mhawr.actor=:actor AND mhawr.role=:role").setParameter("music", music).setParameter("actor", actor).setParameter("role", role).executeUpdate();
            entityTransaction.commit();
            entityManager.refresh(music);
            // entityManager.refresh(actor);
            // entityManager.refresh(role);
    ...
    public List<MediumHasMusic> updateMediumHasMusicList(@PathParam("musicId") int musicId, UpdateMediumHasMusicListPayload updateMediumHasMusicListPayload) throws DbTransactionExecutionException {
        Map<Integer, Collection<TimeRange>> timeRangesByMediumId = updateMediumHasMusicListPayload.getMediumHasMusicListEntries().stream().collect(Collectors.toMap(MediumHasMusicListEntry::getMediumId, MediumHasMusicListEntry::getTimeRanges));
    ...
    public Response removeCategorySet(@PathParam("musicId") int musicId, @PathParam("categorySetId") int categorySetId) {
        ...
        List<Category> categoriesToRemove = categoryList.stream().distinct().filter(musicCategoryList::contains).collect(Collectors.toList());
        entityTransaction.begin();
    ...
    public Response updateMusicFormElement(@PathParam("id") int musicFormElementId, String jsonData) {
        ...
        if (updatedMusicFormElement.getMusicFormElementTranslations().get(0).getText() != null)
            musicFormElement.getMusicFormElementTranslations().get(0).setText(updatedMusicFormElement.getMusicFormElementTranslations().get(0).getText());
    ...
    public List<MusicTranslation> updateMusicTranslationList(@PathParam("musicId") int musicId, @Valid UpdateMusicTranslationListPayload updateMusicTranslationListPayload) throws DbTransactionExecutionException {
        return musicStorage.updateTranslationListOfMusic(musicId, updateMusicTranslationListPayload.getTranslationsByLanguageId());
    }
