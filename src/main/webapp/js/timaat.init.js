requirejs.config({
    ...
    paths: {
        ...
        "TIMAAT-ui-table"                 : 'ui/timaat.table',
        ...
        "TIMAAT-categories"               : 'datasets/timaat.categories',
        ...
        "TIMAAT-segmentStructureElementService" : 'service/timaat.service.segmentstructureelement',
    ...
    shim: {
        ...
        'datatables.net'        : { deps: [ 'jquery' ], exports: '$.fn.dataTable' },
        'datatables.net-bs'     : { deps: [ 'datatables.net' ] },
        'datatables.net-bs4'    : { deps: [ 'datatables.net' ] },
        'datatables.net-responsive': { deps: [ 'datatables.net' ] },
        'datatables.select'     : { deps: [ 'datatables.net' ], init: function() { return $.fn.dataTable; } },
        'datatables.col-reorder': { deps: [ 'datatables.net' ], init: function() { return $.fn.dataTable; } },
