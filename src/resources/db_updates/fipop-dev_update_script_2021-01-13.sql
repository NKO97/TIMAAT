...
ALTER TABLE `FIPOP`.`analysis_segment` CHANGE `sequence_start_time` `start_time` INT(11) NULL DEFAULT NULL;
ALTER TABLE `FIPOP`.`analysis_segment` CHANGE `sequence_end_time` `end_time` INT(11) NULL DEFAULT NULL;
